...
<form class="form-submit" action="registra.php" method="POST">
   ...
   <div class="form-group col-md-6">
    ...
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" name="provincia_legale" id="provincia_legale" placeholder="provincia legale">
     </div>
        <div class="form-group col-md-6">
     ...
     <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" name="cap_legale" id="cap_legale" placeholder="cap legale">
     </div>
        <div class="form-group col-md-6">
     ...
     <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" name="comune_servizio" id="comune_servizio" placeholder="comune di servizio">
     </div>
        <div class="form-group col-md-6">
      <label for="inputText">Email</label>
      <input type="text" class="form-control" name="email1" id="email1" placeholder="indirizzo email1">
     </div>
       <div class="form-group col-md-6">
      <label for="inputText">Provincia Servizio</label>
      <input type="text" class="form-control" name="provincia_servizio" id="provincia_servizio" placeholder="provincia di servizio">
     </div>
        <div class="form-group col-md-6">
      <label for="inputText">Email 2</label>
      <input type="text" class="form-control" name="email2" id="email2" placeholder="indirizzo email secondario">
     </div>
       <div class="form-group col-md-6">
     ...
     </div><label><button class ="btn btn-lg btn-primary btn-block" name= "indirizzo" type="submit">Registra </button>
     </label> </div>
